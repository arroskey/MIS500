...
DESCRIPTION:  THIS PROGRAM ILLUSTRATES HOW TO POOL MEPS DATA FILES FROM DIFFERENT YEARS
	         ...
	         DATA FROM 2016 AND 2017 ARE POOLED.
              ...
              IN THIS PROGRAM THE INSURANCE COVERAGE VARIABLES 'INSCOV17' AND 'INSCOV16' ARE RENAMED TO 'INSCOV'.
...
INPUT FILE:     (1) /folders/myfolders/MEPS/H192.SAS7BDAT (2016 FULL-YEAR FILE)
	            (2) /folders/myfolders/MEPS/H201.SAS7BDAT (2017 FULL-YEAR FILE)
...
TITLE2 'EXERCISE4A.SAS: POOL MEPS DATA FILES FROM DIFFERENT YEARS (2016 and 2017)';
